...
import { PERMISO_REPORTES_SUELDOS, periodoLabel, mesLabel } from '../../utils/sueldos/constantes';
import {
  calcularIndicadorMes, compararSerie, indicadorDeMes, type IndicadorComparado,
} from '../../utils/sueldos/indicadores';
import {
  generarReporteSueldosPDF, type DatosReporteMes, type NominaFilaReporte,
} from '../../utils/sueldos/generarReporteSueldosPDF';
